  ...
  return (
    <div className="space-y-7">
      <div className="space-y-1.5">
        <h2 className="text-[26px] font-bold text-[#0F172A] tracking-tight">Create your account</h2>
        <p className="text-[14.5px] text-[#64748B]">Start your assessment journey today</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-[12px] text-[#94A3B8]">or register with email</span>
        <div className="flex-1 h-px bg-[#F1F5F9]" />
      </div>
      ...
      <form action={action} className="space-y-[15px]">
        ...
        <div>
          ...
          <Input id="name" name="name" type="text" autoComplete="name" placeholder="Arya Dhira" aria-invalid={!!state?.errors?.name} />
          {state?.errors?.name && <p className="mt-1.5 text-[12.5px] text-[#EF4444]">{state.errors.name}</p>}
        </div>
        ...
        <div>
          ...
          {state?.errors?.password
            ? <p className="mt-1.5 text-[12.5px] text-[#EF4444]">{state.errors.password}</p>
            : <p className="mt-1.5 text-[12.5px] text-[#64748B]">Create a strong password for your account (min. 8 characters)</p>
          }
        </div>
